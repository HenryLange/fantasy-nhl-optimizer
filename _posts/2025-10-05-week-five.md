...
test_skater_projection = project_skaters_points_FOR_TOOL(draftable_players_FOR_TOOL, weight_G = 1, weight_A = 0.5, weight_SOG = 0.1,weight_BLK = 0.05,
                                                         weight_PPG = 0.25, weight_PPA = 0.25, weight_SHG = 0.067, weight_SHA = 0.41)
```
...
You can see my code for this week here, in the [week 5 code](https://henrylange.github.io/fantasy-nhl-optimizer/code/week5/) page.
